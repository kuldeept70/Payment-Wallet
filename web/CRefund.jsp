<%-- 
    Document   : CRefund
    Created on : 13 Apr, 2019, 10:05:33 PM
...
<div style="width:60.7%;height:400px;margin-left:25%;float:top;background-color:#F5F5F5;text-align: center;overflow-x: auto;overflow-y: auto;" id="Statement"><br><br>
    ...
    %>
    <p style="font-size:25px;align-items: center;">Refund Money</p><br>
    ...
    <p style="font-size:25px;margin-left:0%">PayJnu Account Number: <%out.print(u.mno);%></p><br>
    <table id="tb1">
        <tr>
            <th>S.No</th>
        ...
        <% ArrayList<TransactionElement> test=mngt.getUnsettledStatement_Cor(u.uname);
           ...
           for(i=0;i<test.size();i++){
                e=test.get(i);%>
                <tr>
                <form action="CRefund" method="post">
                    ...
                    <input type="hidden" name="amt" value="<%out.print(e.Credit);%>">
                    <td><% out.print(i+1); %></td>
