<%-- 
    Document   : CSignUp
    Created on : 3 May, 2019, 11:09:01 PM
...
<form method="post" action="CAuth">
	...
	<p>&nbsp;&nbsp;&nbsp;&nbsp;New to PayJnu Corporate? <a style="color: #0000FF" href="">Sign up</a></p>
</form>
        <hr>
...
<div style="width:60.7%;height:auto;margin-left:25%;float:top;background-color:#F5F5F5;text-align: center;"><br><br>
  <p style="font-size:25px; color:green">New Registration For Corporate Account</p>
  <% if(request.getParameter("MobNo")==null){
   ...
   %>
   <form action="CSignUp.jsp" onsubmit="return validateMob()" method="post">
    ...
    <% } %>
    <% if(request.getParameter("MobNo")!=null){
             if(!CheckMobile.CUserCheck(request.getParameter("MobNo"))){
                 ...
                 if(session.getAttribute("OTP")!=null){ %>
                    <form style="padding: 0 8px;background: #F5F5F5;" action="CSignUp.jsp" method="post">
                    ...
                    <%    if(request.getParameter("otp")!=null){
                                ...
                                RequestDispatcher rd=request.getRequestDispatcher("CSignUp");
                ...
                <% }
                        ...
                        if(session.getAttribute("status")!=null){
                           ...
                           %>
    <form  action="CSignUp.jsp" onsubmit="return validation()" style="margin-left:0%; padding: 0 8px;line-height:23px; background: #F5F5F5;" method="post">
        Name:
        ...
        Select Account Type:
        <select name="type" id="type" style="margin-top: 6px;padding:6px;width:18%;"> 
            <option value="none">select</option>
            <option value="Mess">Mess</option> 
            <option value="Academic">Academic</option> 
            <option value="Others">Others</option> 
        </select><br>
        <span id="typespan" class="text-danger"></span> <br>
        Address:
...
<script>
 function validation(){
	    ...
	    if(cnfpwd==""){
            ...
            if(type=="none"){
                document.getElementById("typespan").innerHTML="* Please Select Account Type";
                return false;
            }
            else
