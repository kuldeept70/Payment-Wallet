<%-- 
    Document   : CustStatement
    Created on : 03 Apr, 2019, 1:14:49 AM
...
<div style="width:60.7%;height:400px;margin-left:25%;float:top;background-color:#F5F5F5;text-align: center;overflow-x: auto;overflow-y: auto;" id="Statement"><br><br>
    <br>
    <p style="font-size:25px;align-items: center;">Account Statement</p><br>
    ...
    <table id="tb1">
        ...
        <% ArrayList<TransactionElement> test=mngt.getAccStatement(u.uname);
           int i;
