 ...
 */
public class CustTrans extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(sess.getAttribute("PageRequest")!=null&&sess.getAttribute("PageRequest").equals("4")){
            ...
            int transfer=m.moneyTransfer(u,rmobile,amount,TimeDate.getDate("yyyy/MM/dd"));
