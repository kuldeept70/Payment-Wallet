 ...
 */
public class PayAcademic extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(sess.getAttribute("PageRequest")!=null&&sess.getAttribute("PageRequest").equals("2")){
            ...
            String runame=request.getParameter("School");
            int amount=Integer.parseInt(request.getParameter("Amount"));
            int transfer=m.TransferToOrg(u, runame, amount,TimeDate.getDate("yyyy/MM/dd"));
            if(transfer!=-1&&transfer!=-2&&transfer!=-3){
                sess.setAttribute("status","School fee Successfully Paid. Your new Balance is: "+transfer);
                u.balance=transfer;
